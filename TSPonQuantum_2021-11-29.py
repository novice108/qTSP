...
#result = hybrid.KerberosSampler().sample(bqm, qpu_params={'label': 'TSP - Kerberos 15-45'})

w = hybrid.SimulatedAnnealingProblemSampler(num_sweeps=1)
#w = hybrid.TabuProblemSampler()
state = hybrid.State.from_problem(bqm)
result = w.run(state).result()
...
#                                              qpu_params={'label': 'Hybrid Computing 09.11 13:50'})
