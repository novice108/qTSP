...
w = hybrid.SimulatedAnnealingProblemSampler(num_reads=None, num_sweeps=1000, initial_states_generator='random')

result = w.run(state_start).result()
...
print("SimulatedAnnealing route ", route)
